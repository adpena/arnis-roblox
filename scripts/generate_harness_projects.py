...
CANONICAL_HARNESS_SAMPLE_DATA_PATHS = {
    "src/ServerStorage/SampleData/AustinCanonicalManifestIndex.lua",
    "src/ServerStorage/SampleData/AustinCanonicalManifestChunks/**",
}
...
def _build_build_project(
    default_project_data: dict,
    *,
    ...
    build_visible_paths = set(CANONICAL_HARNESS_SAMPLE_DATA_PATHS)
