...
return function()
    ...
    Assert.equal(migrated.chunks[1].roads[1].hasSidewalk, false, "expected migrated sidewalk default")
    ...
    Assert.near(result040.chunks[1].roads[1].points[2].x, 30 * scale, 0.01, "expected scaled road point x")
    Assert.near(result040.chunks[1].roads[1].widthStuds, 10 * scale, 0.01, "expected scaled road widthStuds")
    ...
    Assert.near(result040.chunks[1].buildings[1].height, 12 * scale, 0.01, "expected scaled building height")
    ...
    Assert.equal(result040.chunks[1].buildings[1].wallColor ~= nil, true, "expected wallColor present")
