...
AustinPreviewBuilder.FULL_MANIFEST_INDEX_NAME = CanonicalWorldContract.resolveCanonicalManifestFamily("preview")
...
local function loadPreviewAcceleratorHandle(timeTravelActive)
    return ManifestLoader.LoadShardedModuleHandle(
        AustinPreviewFolder[AustinPreviewBuilder.FALLBACK_PREVIEW_INDEX_NAME],
        AustinPreviewFolder[AustinPreviewBuilder.FALLBACK_PREVIEW_CHUNKS_NAME],
        nil,
        {
...
local function loadPreviewManifestSource(timeTravelActive)
    ...
    local previewManifest = loadPreviewAcceleratorHandle(timeTravelActive)
